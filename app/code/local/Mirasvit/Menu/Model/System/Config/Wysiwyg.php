...
class Mirasvit_Menu_Model_System_Config_Wysiwyg extends Varien_Object
{
    /**
     * Wysiwyg behaviour
     */
    ...
    public function getConfig($data = array())
    {
        ...
        if (Mage::getSingleton('admin/session')->isAllowed('cms/media_gallery')) {
            $config->addData(array(
                ...
                'widget_window_url' => Mage::getSingleton('adminhtml/url')->getUrl('adminhtml/cms_block_widget/index'),
            ));
        }
